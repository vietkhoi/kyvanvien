...
function Profile() {
    const [fullName, setFullName] = useState('Kevin Anderson');
    const [about, setAbout] = useState('Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.');
                                        ...
                                        <form>
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-8 col-lg-9">
                                                    <img src="../assets/img/OIP.jpg" alt="Profile" />
                                                    <div className="pt-2">
                                            ...
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-8 col-lg-9">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" id="changesMade" checked onChange={() => {}} />
                                                        <label className="form-check-label" htmlFor="changesMade">
                                                            Changes made to your account
                                                        </label>
                                                    </div>
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" id="newProducts" checked onChange={() => {}} />
                                                        <label className="form-check-label" htmlFor="newProducts">
                                                            Information on new products and services
                                                        </label>
                                                    </div>
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" id="proOffers" onChange={() => {}} />
