...
$(document).ready(function () {
    ...
    // Kiểm tra trạng thái chế độ chủ đề khi trang được tải
    ...
    if (themeMode.length > 0) {
        themeMode.on('change', function (e) {
            ...
            localStorage.setItem('bg_color', valueThemeMode); // Lưu trạng thái vào localStorage
...
//         function handleChangeListHot(category_id) {
//             fetch('/api/get-list-story-hot', {  // Cập nhật URL API ở đây
//                 method: 'POST',
//                 headers: {
//                     'Accept': 'application/json',
//                     'Content-Type': 'application/json',
